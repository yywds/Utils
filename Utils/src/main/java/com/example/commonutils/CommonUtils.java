...
public class CommonUtils {
    ...
    public static void SelectDialogShow(Context context,String message,Class<?> cls){
        ...
        confirmDialog.setLogoImg(R.drawable.ic_launcher_background).setMsg(message);
    ...
    public static void FangWeixinDialog(Context context,String text){
        Notification.show(context, 1, R.drawable.ic_launcher_background, context.getString(R.string.app_name), text, Notification.SHOW_TIME_LONG,TYPE_NORMAL );
    }
     ...
     * @return
     */
    public static Call GetUrl(String url){
        //异步请求
     ...
     * @return
     */
    public static Request PostUrl(String url){
